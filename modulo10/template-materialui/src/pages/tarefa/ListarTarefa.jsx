...
//Abaixo é usado typescript para melhorar só mudando para tsx e ajustando. Javascript aceita qualquer tipo de variavel sendo tudo any
// function createData(
//   idTarefa: number,
//   tituloTarefa: string,
...
const initialRows = [
  createData(1, 'Teste 1 fixo', 'Descrição da Tarefa 1', '2022-01-01', '2022-01-02', 'Concluída', 'Recurso 1'),
  createData(2, 'Teste 2 cel', 'Descrição da Tarefa 2', '2022-01-03', '2022-01-04', 'Aguardando', 'Recurso 2'),
  createData(3, 'Teste 7', 'Descrição da Tarefa 3', '2022-01-04', '2022-01-05', 'Em Andamento', 'Recurso 3'),
  createData(4, 'Tasks 0', 'Descrição da Tarefa 4', '2022-01-05', '2022-01-06', 'Concluída', 'Recurso 4'),
  createData(5, 'Programming', 'Descrição da Tarefa 5', '2022-01-06', '2022-01-07', 'Concluída', 'Recurso 5'),
  createData(6, 'Repeat', 'Descrição da Tarefa 6', '2022-01-07', '2022-01-08', 'Aguardando', 'Recurso 6'),
];
